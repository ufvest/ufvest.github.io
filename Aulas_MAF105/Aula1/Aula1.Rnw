...
<<bp, echo=FALSE, out.width=".3\\textwidth", pdfcrop=TRUE, fig.width=4,fig.height=3,include=TRUE,fig=TRUE>>=
...
\begin{center}
\setkeys{Gin}{width=0.5\linewidth}
<<pizza, echo=FALSE, out.width=".3\\textwidth", pdfcrop=TRUE, fig.width=4,fig.height=3,include=TRUE,fig=TRUE>>=
...
\begin{center}
\setkeys{Gin}{width=0.5\linewidth}
<<ogiva, echo=FALSE, out.width=".3\\textwidth", pdfcrop=TRUE, fig.width=4,fig.height=3,include=TRUE,fig=TRUE>>=
...
\begin{block}{}
\justifying
Os cinco valores, $x(1), q_{1}, q_{2}, q_{3}\ e\ x_{(n)}$ são importantes para se ter uma boa ideia da assimetria da distribuição dos dados. Para uma distribuição simétrica 
